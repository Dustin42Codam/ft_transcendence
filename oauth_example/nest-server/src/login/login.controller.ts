...
export class LoginController {
	...
	userLogin(@Req() request: Request, @Res() response: Response) {
		...
		// response.redirect(`https://api.intra.42.fr/oauth/authorize?client_id=7c59d418a12bb6da95283ca1866d0db3946ff94528e8d7be5b98545c31f892ff&redirect_uri=http%3A%2F%2Flocalhost%3A9000%2Foauth-callback&response_type=code&state=${stateValue}`);
