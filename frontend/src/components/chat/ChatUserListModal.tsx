...
import { fetchChatMembers, fetchJoinableUsers, selectJoinableUsers } from "../../redux/slices/chatMembersSlice";
...
async function addUserToChat(props: any) {
	...
	props.dispatch(fetchJoinableUsers({
		id: props.currentChat.id
	}))
}
